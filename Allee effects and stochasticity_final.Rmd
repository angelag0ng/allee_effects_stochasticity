...
fig1a <- ggplot(d.fig1a)+
  ...
  ylab("Expected per capita growth rate, <br> *N(t+1) / N(t)*")+
  xlab("Population size, *N(t)*")+
  theme_bw()+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        strip.background = element_rect(fill="white"),
        legend.position = "top",panel.background = element_rect(colour = "black"),
        axis.title.y = element_markdown(), axis.title.x = element_markdown())
...
ggsave(filename = "fig1.pdf", plot = fig1, width = 9.4, height = 3, useDingbats = FALSE)
```
...
fig2a <- ggplot(d.fig2a)+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        strip.background = element_rect(fill="white"),legend.key = element_rect(fill = NA, color = NA),
        legend.position = "top",panel.background = element_rect(colour = "black"),
        axis.title.y = element_markdown(), axis.title.x = element_markdown())
...
fig2b <- ggplot(d.fig2b)+
  ...
  scale_y_continuous(trans = "log10", name = "Catastrophic Extinction Return <br> Times Where Demographic <br> Stochasticity is Critical")+
  ...
  theme_bw()+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        strip.background = element_rect(fill="white"),legend.position = "right",
...
fig2c <- ggplot(d.fig2c)+
  ...
  scale_y_continuous(trans = "log10", 
                     name = "Catastrophic Extinction Return <br> Times Where Demographic <br> Stochasticity is Beneficial",
...
```{r}
ggsave(filename = "fig2a.pdf", plot = fig2a, width = 4, height = 6, useDingbats = FALSE)
ggsave(filename = "fig2b.pdf", plot = fig2b, width = 6, height = 3, useDingbats = FALSE)
ggsave(filename = "fig2c.pdf", plot = fig2c, width = 6, height = 3, useDingbats = FALSE)
```
...
fig3a <- ggplot(d.fig3)+
  ...
  scale_colour_manual(name='Strength of Demographic Stochasticity, *S*',
...
fig3b <- ggplot(d.fig3)+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        ...
        strip.text = element_blank(), axis.title.x = element_markdown())
...
```{r}
fig3 <- ggarrange(fig3a, fig3b, ncol = 1, labels = c("A","B"))
ggsave(filename = "fig3.pdf", plot = fig3, width = 9, height = 6, useDingbats = FALSE)
```

### fig. 4 - stochastic immigration

```{r}
fig4 <- ggplot(d.fig4, aes(x=b,y=col.prob,colour=S,by=Immigration)) +
  geom_line(aes(linetype=Immigration))+
  geom_point()+
  scale_y_continuous(trans="log10",
                     name = "Probability of Colonization")+
  xlab("Attenuation point, *b*")+
  scale_colour_discrete(name='Strength of Demographic Stochasticity, *S*',
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        ...
        strip.background = element_rect(fill = "white"),
        legend.title = element_markdown(), axis.title.x = element_markdown())+
  guides(linetype = guide_legend(nrow = 1), colour = guide_legend(nrow = 1))

fig4

ggsave(filename = "fig4.pdf", plot = fig4, width = 9, height = 3.5, useDingbats = FALSE)
```
